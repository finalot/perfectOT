	...
	<tr>
		<th scope="row">SUBJECT</th>
           <td><select id="subject" name="subject">
			<option value="[배송문의]">[입금확인/입금자변경]</option>
			</select>  	
		   </td>
    </tr>
	...
	<tbody>
		...
		<div class="ec-base-button ">
            <span class="gLeft">
                ...
                <a href="bank_insert_board.jsp" class="yg_btn_30 yg_btn4" alt="목록">LIST</a>
            </span>
            <span class="gRight">
                <a href="#none" onclick="BOARD_WRITE.form_submit('boardWriteForm');" class="yg_btn_30 yg_btn4" alt="등록">OK</a>
                <a href="bank_insert_board.jsp" class="yg_btn_30 yg_btn4" alt="취소">CANCEL</a>
            </span>
        </div>
	</div>
</form>
